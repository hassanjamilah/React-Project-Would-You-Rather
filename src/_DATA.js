let users = {
  sarahedo: {
    id: 'sarahedo',
    name: 'Sarah Edo',
    avatarURL: 'https://www.shareicon.net/data/512x512/2016/06/25/786525_people_512x512.png',
    answers: {
  ...
  tylermcginnis: {
    id: 'tylermcginnis',
    name: 'Tyler McGinnis',
    avatarURL: 'https://image.shutterstock.com/image-vector/businessman-character-avatar-icon-260nw-519895501.jpg',
    answers: {
...
export function _saveQuestion (question) {
  return new Promise((res, rej) => {
    ...
    console.log('will add question: ' , question , authedUser)
    setTimeout(() => {
      questions = {
        ...questions,
